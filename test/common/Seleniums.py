...
class BasePage(object):
	...
	def get_screent_img(self, value):
		...
		screen_name = file_path + value + '.png'
		try:
...
if __name__ == '__main__':
	...
	opt.add_experimental_option("mobileEmulation", me)
	wd = webdriver.Chrome(chrome_options=opt, executable_path="/opt/homebrew/bin/chromedriver")
	wd.get("https://m.zuw47011.vip/")
	base = BasePage(wd)
	print(base.get_page_title())
	base.get_screent_img("test")
	print(base.get_attribute)
	time.sleep(20)
	base.quit()
